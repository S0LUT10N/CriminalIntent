...
class CrimeFragment : Fragment(), DatePickerFragment.Callbacks, TimePickerFragment.Callbacks {
    ...
    override fun onStart() {
        ...
        callSuspectButton.apply {
            setOnClickListener {
                ...
                val pickContactIntent = Intent(Intent.ACTION_PICK, contactUri)
                startActivityForResult(pickContactIntent, REQUEST_CONTACT)
            }
    ...
    private fun updateUI() {
        ...
        val formattedDateFormat = SimpleDateFormat(DATE_FORMAT, Locale.ENGLISH)
        val formattedDate = formattedDateFormat.format(crime.date)
        dateButton.text = formattedDate

        timeButton.text = DateFormat.format(TIME_FORMAT, crime.date).toString()
